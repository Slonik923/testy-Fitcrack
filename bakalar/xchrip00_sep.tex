...
\projectinfo{
  ...
  keywords.cs={Fitcrack, BOINC, testovanie, automatizované testy, jednotkové testy, integračné testy, testovanie založené na požiadavkách, Python, SQL Alchemy}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={Fitcrack, BOINC, testing, automated tests, unit testing, integration testing, requirement-based testing, Python, SQL Alchemy}, % klíčová slova v anglickém jazyce / keywords in english
  % Abstrakt / Abstract
...
Práca ďalej obsahuje popis architektúry systému Fitcrack, návrh testov a vybrané detaily samotnej implementácie.}, % abstrakt v českém či slovenském jazyce / abstract in czech or slovak language
  ...
  Thesis also includes a description of the Fitcrack architecture, the design of tests, and selected details of the implementation itself.}
...
\fi
  ...
  % Přílohy / Appendices
 % \input{xchrip00_sep-30-prilohy-appendices}
