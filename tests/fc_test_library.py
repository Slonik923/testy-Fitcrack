...
class ServerSubsystems(Enum):
    sample_work_generator = "work_generator"
    sample_assimilator = "assimilator"
    sample_bitwise_validator = "bitwise_validator"
...
def get_running_modules():
    ...
    for proc in psutil.process_iter():
        if proc.name() in get_subsystem_name_list():
...
def get_server_info():
    ...
    for proc in psutil.process_iter():
        for subsystem in ServerSubsystems:
